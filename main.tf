...
resource "aws_subnet" "private" {
  ...
  # Option 1: Change to an availability zone that supports t2.micro
  availability_zone = "ap-south-1a"
  # Option 2: Remove availability_zone to let AWS choose one
  # Note: Uncomment the following line and comment out the line above to use Option 2.
